...
public class Main implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<Product> listOfGoods = new ArrayList();
                ...
                switch (answer2) {
                    ...
                    case 3:
                        ...
                        for (int i = 0; i <= length; i++) {
                            Product product = listOfGoods.get(0);
                            productService.newListOfMarks(product.getAmountOfOrders(), productService.listOfMarksMethod(product.getAmountOfOrders()));
